...
function StudentListPage() {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`https://api-flrming.dhoomaworksbench.site/api/game/${id}/`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
    ...
    const handleDeleteCampus = async () => {
        try {
            await axios.delete(`https://api-flrming.dhoomaworksbench.site/api/student/delete-all/`, {
                headers: {
                    'Authorization': `Bearer ${token}`
                }
            });
